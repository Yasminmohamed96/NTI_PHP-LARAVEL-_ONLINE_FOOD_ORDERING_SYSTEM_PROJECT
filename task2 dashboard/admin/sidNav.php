                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="http://localhost/SESSIONONE/online%20resturants/NTI_PHP-LARAVEL-_ONLINE_FOOD_ORDERING_SYSTEM_PROJECT/task2%20dashboard/admin/CRUD_MEALS_MODULE/view_all_resturants_meal.php">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="http://localhost/SESSIONONE/online%20resturants/NTI_PHP-LARAVEL-_ONLINE_FOOD_ORDERING_SYSTEM_PROJECT/task2%20dashboard/admin/CRUD_USER_MODULE/create_user.php">register new user </a>
